...
parser.add_argument('--model_name', type=str, default='Distg_v10', help="model name")
parser.add_argument("--use_pre_ckpt", type=bool, default=True, help="use pre model ckpt")
parser.add_argument("--path_pre_pth", type=str, default='E:/LFSR-New/RR-HLFSR_NTIRE2023_LFSR-main/Distg_v10_5x5_4x_epoch_42_model.pth', help="path for pre model ckpt")
...
parser.add_argument('--path_for_train', type=str, default='E:/dataset/LFSR_dataset/data_for_training/')
parser.add_argument('--path_for_test', type=str, default='E:/LFSR-New/RR-HLFSR_NTIRE2023_LFSR-main/data_for_test/')
...
parser.add_argument("--step_validation", type=int, default=5, help="number of epochs to perform validation")

# HLFSR network settings
parser.add_argument("--n_groups", type=int, default=10, help="number of HLFSR-Groups")
parser.add_argument("--n_blocks", type=int, default=5, help="number of SRBs blocks in one HFEM")
